            ...
            <div class="table-section">
                <table>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM inventory_request ORDER BY id DESC LIMIT 15";
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="request_delete.php" method="post" onsubmit="return confirm('Are you sure you want to delete this request?');">
                                            <input type="hidden" name="request_id" value="<?php echo $row['id']; ?>">
                                            <button type="submit" style="color: Blue;">↩️ Undo</button>
                                        </form>
                                    </td>
